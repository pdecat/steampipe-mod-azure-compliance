locals {
  cis_v200_8_common_tags = merge(local.cis_v200_common_tags, {
    cis_section_id = "8"
  })
}
...
control "cis_v200_8_1" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_1.md")
...
control "cis_v200_8_3" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_3.md")
...
control "cis_v200_8_4" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_4.md")
...
control "cis_v200_8_5" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_5.md")
...
control "cis_v200_8_6" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_6.md")
...
control "cis_v200_8_7" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_8_7.md")
