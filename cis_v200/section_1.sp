...
locals {
  ...
  cis_v200_1_2_common_tags = merge(local.cis_v200_1_common_tags, {
    cis_section_id = "1.2"
  })
}
...
control "cis_v200_1_2_1" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_2_1.md")
...
control "cis_v200_1_2_2" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_2_2.md")
...
control "cis_v200_1_2_3" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_2_3.md")
...
control "cis_v200_1_2_4" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_2_4.md")
...
control "cis_v200_1_2_5" {
  ...
  description   = "For designated users, they will be prompted to use their multi-factor authentication (MFA) process on login."
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_2_5.md")
...
control "cis_v200_1_2_6" {
  ...
  documentation = file("./cis_v200/docs/cis_v200_1_2_6.md")
...
control "cis_v200_1_24" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_24.md")
...
control "cis_v200_1_25" {
  ...
  query         = query.ad_manual_control
  documentation = file("./cis_v200/docs/cis_v200_1_25.md")
